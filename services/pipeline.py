...
class SummarizationPipeline:
    ...
    async def execute(self, request: SummarizeRequest) -> SummarizeResponse:
        ...
        logger.info("Summarization request received", extra={
        ...
        try:
            ...
            elapsed = time.time() - start_time
            logger.info("Summarization completed", extra={
                "elapsed_seconds": elapsed,
            ...
            elapsed = time.time() - start_time
            logger.error(f"LLM service unavailable: {str(e)}", extra={
                "elapsed_seconds": elapsed,
            ...
            elapsed = time.time() - start_time
            logger.error(f"Response parsing failed: {str(e)}", extra={
                "elapsed_seconds": elapsed,
            })
            # Вернуть fallback ответ
            return SummarizeResponse(
